...
def generate_icon():
    ...
    draw.rectangle(
        [(10, 10), (img_size - 10, img_size - 10)], fill=background_color, width=0
    )
    ...
    smaller_text_position = (
        (img_size - smaller_text_width) // 2,
    ...
    try:
        ...
        print(
            "You may need to convert the PNG to ICO manually using an online converter."
        )
