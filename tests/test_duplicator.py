...
class TestDuplicator(unittest.TestCase):
    ...
    def test_validate_github_url(self):
        ...
        # Valid GitHub URLs
        self.assertTrue(
            duplicator.validate_github_url("https://github.com/user/repo.git")
        )
        self.assertTrue(
            duplicator.validate_github_url("https://github.com/user/repo-name.git")
        )

        # Invalid GitHub URLs
        self.assertFalse(
            duplicator.validate_github_url("https://gitlab.com/user/repo.git")
        )
        self.assertFalse(duplicator.validate_github_url("https://github.com/user/repo"))
        self.assertFalse(
            duplicator.validate_github_url("http://github.com/user/repo.git")
        )
